...
import { GetPrioritizedPatientsRequestDTO, GetPrioritizedPatientsResponseDTO, PrioritizedPatientDTO } from '../dto/PrioritizedPatientDTO';
...
export class GetPrioritizedPatients {
  ...
  async execute(request: GetPrioritizedPatientsRequestDTO): Promise<GetPrioritizedPatientsResponseDTO> {
